<?php
    ...
    require '../../../scripts/appListaTarefas/tarefaController.php';
?>
...
<html lang = "pt-pt">
    ...
    <body>
        ...
        <div class = "container app">
            <div class = "row">
                ...
                <div class = "col-md-3 menu">
                    <ul class = "list-group">
                        <a class = "list-group-item active bg-success text-white border-success" href = "index.php">Tarefas pendentes</a>
        ...
        <script>
                ...
                formulario.action = 'index.php?pag=index&acao=atualizar'
